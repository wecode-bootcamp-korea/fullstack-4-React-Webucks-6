          ...
          <div className="info-box">
              ...
              <div className="text-box">
                  <div className="text-box-head">
                      ...
                      <div className="heart-text"><i className="fa-regular fa-heart"></i></div>
                  </div>
                  ...
                  <div className="text-box-review-comment">
                      <p> <strong>coffee_lover</strong> 너무 맛있어요!</p>
                      <p><strong>CHOCO7</strong> 오늘도 화이트 초콜릿 모카를 마시러 갑니다.</p>
                      <p><strong>legend_dev</strong> 진짜 화이트 초콜릿 모카는 전설이다. 진짜 화이트 초콜릿 모카는 전설이다.</p>
                  </div>

                  <input type="text" className="text-box-review-input" placeholder="리뷰를 입력해주세요."></input>
              </div>
          </div>
      </div><footer>
